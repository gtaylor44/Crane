...
namespace IntegrationTest
{
    ...
    public class SelectAsyncTest
    {
        ...
        public async Task GetProducts()
        {
            ...
            {
                var products = await conn.Select()
        ...
        public async Task SelectSingleCustomerAndOrders()
        {
            ...
            using (SqlConnection conn = SqlConnectionFactory.GetSqlConnection())
            {
                ...
                await conn.Select()
                    ...
                    .ExecuteReaderAsync<Customer, Order>(conn, "dbo.GetCustomerAndOrders", (c, o) =>
                    {
                        if (cust == null)
                        {
                            cust = c;
        ...
        public async Task GetSuppliers()
        {
            using (SqlConnection conn = SqlConnectionFactory.GetSqlConnection())
            {
                var suppliers = await conn.Select().ExecuteReaderAsync<Supplier>(conn, "dbo.GetSuppliers");
        ...
        public async Task GetCustomer()
        {
            using (SqlConnection conn = SqlConnectionFactory.GetSqlConnection())
            {
                var customer = (await conn.Select()
        ...
        public async Task GetSupplierByName()
        {
            using (SqlConnection conn = SqlConnectionFactory.GetSqlConnection())
            {
                var supplier = (await conn.Select()
