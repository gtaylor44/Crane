...
namespace SprocMapperLibrary.MySql
{
    ...
    public class MySqlUserQuery : BaseQuery
    {
        ...
        /// <inheritdoc />
        public override T ExecuteScalar<T>(string query, int? commandTimeout = null, DbConnection dbConnection = null)
        {
            try
            {
                query = GetCleanSqlCommand(query);
        ...
        /// <inheritdoc />
        public override async Task<T> ExecuteScalarAsync<T>(string query, int? commandTimeout = null, DbConnection dbConnection = null)
        {
            try
            {
                query = GetCleanSqlCommand(query);
